				...
				if (AddonUtil.checkUserInput(propertiesTextfield.getText())) {
					if (AddonUtil.checkUserInput(idBukkit.getText())) {
						if (AddonUtil.checkUserInput(idSpigot.getText())) {
							...
							DialogUtil.showErrorAlert("Fehler", "", "Spigot-Datei ist nicht ausgew�hlt");
						}
					} else {
						DialogUtil.showErrorAlert("Fehler", "", "Bukkit-Datei ist nicht ausgew�hlt");
					}
				} else {
					DialogUtil.showErrorAlert("Fehler", "", "Properties-Datei ist nicht ausgew�hlt");
				}
			} else {
				DialogUtil.showErrorAlert("Fehler", "", "Java-Datei ist nicht ausgew�hlt");
			}
		} else {
